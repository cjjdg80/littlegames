...
class GameDataPreprocessingTester {
    ...
    async testPreprocessedGames() {
        ...
        this.testResults.preprocessedGames = {
            ...
            allGamesValid: games.every((game) => this.validateGameFields(game))
        };
    ...
    printTestResults() {
        ...
        // 总体结果
        const allTestsPassed = (this.testResults.preprocessedGames?.fileExists &&
